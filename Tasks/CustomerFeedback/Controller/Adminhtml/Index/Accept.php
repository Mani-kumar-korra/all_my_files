...
use Tasks\CustomerFeedback\Model\FeedbackFactory as ModelFactory;
use Tasks\CustomerFeedback\Model\ResourceModel\Feedback as FeedbackResourceModel ;
use Tasks\CustomerFeedback\Helper\Mail ;
    ...
    public function execute()
    {
        ...
        if($getData){
            ...
            try{
                ...
                $redirect->setPath('customerfeedback1/index/index');
                return $redirect;
            }
            catch(\Exception $e){
